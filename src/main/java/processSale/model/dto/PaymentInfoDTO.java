...
public class PaymentInfoDTO {
    private final double amountPaid;       // The total amount paid by the customer
    private final double changeToGiveBack; // The change to return to the customer
    private final double totalPrice;       // The total price of the sale (including VAT)
    private final double totalVAT;         // The total VAT for the sale
     ...
     */
    public PaymentInfoDTO(double amountPaid, double change, double totalPrice, double totalVAT) {
